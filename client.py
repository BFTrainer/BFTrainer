...
parser.add_argument('--Ns', type=int, required=True, nargs='+', help='num of nodes for scaling')
parser.add_argument('--Os', type=float, required=True, nargs='+', help='objective ratio rate')
...
def main():
    ...
    id = m.submit_job(min=args.min, max=args.max, Ns=args.Ns, 
                    Os=args.Os, res_up=args.res_up, res_dw=args.res_dw, path=args.path)
